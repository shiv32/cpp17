...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "System Monitor (simple top)\n";
        cout << "---------------------------------\n";
        cout << "Uptime: "
        ...
        cout << "Memory: " << memUsed / 1024 << " MB / " << mi.memTotal / 1024 << " MB ("
             << memPercent << "%)\n";
        cout << "Swap: " << swapUsed / 1024 << " MB / " << mi.swapTotal / 1024 << " MB ("
             << swapPercent << "%)\n";
    ...
    // Exit alternate screen (unreachable in this loop)
    cout << "\033[?1049l";
}
