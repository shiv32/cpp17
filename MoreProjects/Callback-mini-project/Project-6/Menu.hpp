...
{
public:
	using EventHandler = void (BaseHandler::*)(int);
	using ExitHandler = bool (BaseHandler::*)();
...
#define HANDLER(pmf) reinterpret_cast<void(BaseHandler::*)(int)>(pmf)