...
int main()
{
    ...
    menu.RegisterMenuItem("Square", OnSquare);       // fun pointer
    menu.RegisterMenuItem("Double", OnDouble);       // fun pointer
    menu.RegisterMenuItem("Increment", OnIncrement); // fun pointer
