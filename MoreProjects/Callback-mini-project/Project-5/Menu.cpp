...
void Menu::Run()
{
	while (true)
	{
		...
		{
			(m_pNumbersInput->*m_PersistentHandler)(-1);
		}
		DisplayMenuItems();
...
Menu::Menu(NumbersInput *pNumbersInput) : m_pNumbersInput{pNumbersInput}
{
}
...
bool Menu::CheckExit()
{
	if (m_ExitHandler)
	{
		return (m_pNumbersInput->*m_ExitHandler)();
	}
	return true;
}
