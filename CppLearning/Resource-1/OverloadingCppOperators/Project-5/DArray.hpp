// write your own dynamically allocated array class.
...
//throws an exception when the given index is out of bounds
template <typename T>
...
//return a zero-initialized element instead of throwing
// template <typename T>
// const T &Array<T>::operator[](size_t x) const
// {
//     if (x >= mSize)
