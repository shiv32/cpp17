...
void led_toggler1(led_base *led)
{
    // Use dynamic polymorphism to toggle a base class pointer.
    led->toggle();
}

void led_toggler2(led_base &led)
{
    // Use dynamic polymorphism to toggle a base class pointer.
    led.toggle();
}
...
void do_something()
{
    led_toggler1(&led0); // Toggle an led_port.
    led_toggler1(&led1); // Toggle an led_port.
    led_toggler1(&led2); // Toggle an led_pwm.
    led_toggler1(&led3); // Toggle an led_pwm.
}

void do_something2()
{
    led_toggler1(static_cast<led_base *>(&led0));
    led_toggler1(static_cast<led_base *>(&led1));
    led_toggler1(static_cast<led_base *>(&led2));
    led_toggler1(static_cast<led_base *>(&led3));
}

void do_something3()
{
    led_toggler2(led0); // Toggle an led_port.
    led_toggler2(led1); // Toggle an led_port.
    led_toggler2(led2); // Toggle an led_pwm.
    led_toggler2(led3); // Toggle an led_pwm.
}
